...
public class BpDownloader {
    ...
    private final String Base_Url = ApCo.BP_BASE_URL;
    private final String Data_Dir = ApCo.ROOT_DIR + File.separator + ApCo.BP_DIR_NAME;
    private final String File_Prefix = ApCo.NSE_BP_FILE_PREFIX;
    private final String File_Suffix = ApCo.NSE_BP_FILE_SUFFIX;
    private final String File_Ext = ApCo.NSE_BP_FILE_EXT;
    private final String File_Date_Regex = ApCo.NSE_BP_FILE_NAME_DATE_REGEX;
    private final String File_Date_Format = ApCo.NSE_BP_FILE_NAME_DATE_FORMAT;
...
//    }
    ...
    private void transformToCsv(String downloadedDirAndFileName) {
        ...
        String toFile = ApCo.ROOT_DIR + File.separator + ApCo.BP_DIR_NAME + File.separator + csvFileName;
