...
@Component
@PropertySource(value = "classpath:avg-query-03.yaml", factory = YamlPropertyLoaderFactory.class)
public class AvgCalculation03Dao {
    ...
    AvgCalculation03Dao(JdbcTemplate jdbcTemplate) {
